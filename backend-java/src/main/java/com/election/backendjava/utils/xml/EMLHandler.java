package com.election.backendjava.utils.xml;
    ...
    public void endElement(String uri, String localName, String qName) {
        ...
        switch (localName) {
            ...
            case REGISTERED_PARTY:
                ...
                break;
            case CANDIDATE:
                // Small change to eml handler
                if (candidateTransformer != null) {
                    String currentAffiliationId = savedElectionData.peek().get(AFFILIATION_IDENTIFIER + "-" + ID);
                    String currentRegisteredName = savedElectionData.peek().get(REGISTERED_NAME);

                    if (currentAffiliationId != null) {
                        electionData.put(AFFILIATION_IDENTIFIER + "-" + ID, currentAffiliationId);
                    }
                    if (currentRegisteredName != null) {
                        electionData.put(REGISTERED_NAME, currentRegisteredName);
                    }
